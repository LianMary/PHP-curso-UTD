				...
				<div class="col-12">
					<div class="card">
					  <div class="card-header bg-success">
						...
						<div class="card-body">
                            <form action="receive.php?date=<?=date('Ymd');?>&hour=<?=date('His');?>&color=red" method="POST">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label"><span class="iconify" data-icon="mingcute:whatsapp-fill" style="color: #198754;"></span> Telefone Celular </label>
                                        <input type="text" class="form-control whatsapp" id="exampleFormControlInput1" placeholder1="Nome do Produto" name="cellphone">
                                        </div>
                                    </div>

                                    <div class="col-6">
                                        <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label"><span class="iconify" data-icon="mingcute:whatsapp-fill" style="color: #198754;"></span> Estado </label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder1="Nome do Produto" name="state">
                                        </div>
                                    </div>
