          ...
          <ul class="navbar-nav float-start me-auto">
            ...
            <li class="nav-item search-box">
              ...
              <form class="app-search position-absolute">
                <input name="" type="text" class="form-control" placeholder="Search &amp; enter" />
                <a class="srh-btn">
      ...
      <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link waves-effect waves-dark sidebar-link" href="http://localhost/aula24/sistema/produtos/listProduct.php" aria-expanded="false">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-body">
              <h4 class="card-title">Edição de Clientes</h4>
              <h5 class="card-subtitle">Preencha os dados conforme seus campos</h5>
              
              <form action="client.php" method="POST" class="form-horizontal mt-4">
                <div class="row">
                  <div class="col-6">
                    <div class="mb-3">
                      ...
                      <input value="<?=$data[0];?>" name="fullName" type="text" class="form-control" id="exampleFormControlInput1" placeholder1="Nome do Cliente">
                    </div>
                  ...
                  <div class="col-6">
                    <div class="mb-3">
                      ...
                      <input value="<?=$data[1];?>" name="email" type="email" class="form-control" id="exampleFormControlInput1" placeholder1="Nome do Produto">
                    </div>
                  </div>                  

                  <div class="col-6">
                    <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label"><span class="iconify" data-icon="fa6-solid:calendar" style="color: #198754;"></span> Data de Nascimento </label>
                      <input value="<?=$data[2];?>" name="birthDate" type="date" class="form-control" id="exampleFormControlInput1" placeholder1="Nome do Produto">
                    </div>
                  </div>
                  ...
                  <div class="col-6">
                    <div class="mb-3">
                      ...
                      <input value="<?=$data[3];?>" name="document" type="text" class="form-control cpf" id="exampleFormControlInput1" placeholder1="Nome do Produto">
                    </div>
                  </div>
                  ...
                  <div class="col-6">
                    <div class="mb-3">
                      ...
                      <input value="<?=$data[4];?>" name="address" type="text" class="form-control" id="exampleFormControlInput1" placeholder1="Nome do Produto">
                    </div>
                  </div>
                  ...
                  <div class="col-6">
                    <div class="mb-3">
                      ...
                      <input value="<?=$data[5];?>" name="postalCode" type="text" class="form-control cep" id="exampleFormControlInput1" placeholder1="Nome do Produto">
                    </div>
                  </div>
                  ...
                  <div class="col-6">
                    <div class="mb-3">
                      ...
                      <input value="<?=$data[6];?>" name="phone" type="text" class="form-control telefone" id="exampleFormControlInput1" placeholder1="Nome do Produto">
                    </div>
                  </div>
                  ...
                  <div class="col-6">
                    <div class="mb-3">
                      ...
                      <input value="<?=$data[7];?>" name="ehatsapp" type="text" class="form-control whatsapp" id="exampleFormControlInput1" placeholder1="Nome do Produto">
                    </div>
                  </div>
