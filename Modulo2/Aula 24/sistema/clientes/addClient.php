        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-body">
              <h4 class="card-title">Adição de Clientes</h4>
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <div class="mb-3">
                      ...
                      <input name="birthDate" type="date" class="form-control" id="exampleFormControlInput1" placeholder1="Nome do Produto">
                    </div>
                  </div>
                  ...
                  <div class="col-6">
                    <div class="mb-3">
                      ...
                      <input name="address" type="text" class="form-control" id="exampleFormControlInput1" placeholder1="Nome do Produto">
                    </div>
                  </div>
                  ...
                  <div class="col-6">
                    <div class="mb-3">
                      ...
                      <input name="postalCode" type="text" class="form-control cep" id="exampleFormControlInput1" placeholder1="Nome do Produto">
                    </div>
                  </div>
                  ...
                  <div class="col-6">
                    <div class="mb-3">
                      ...
                      <input name="ehatsapp" type="text" class="form-control whatsapp" id="exampleFormControlInput1" placeholder1="Nome do Produto">
                    </div>
                  </div>
