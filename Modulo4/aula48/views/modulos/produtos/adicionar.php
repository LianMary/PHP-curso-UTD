                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <input name="codigo" type="text" class="form-control" id="exampleFormControlInput1" placeholder1="Nome do Produto">
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <input name="estoque" type="text" class="form-control" id="exampleFormControlInput1" placeholder1="Nome do Produto">
                        </div>
                    </div>
